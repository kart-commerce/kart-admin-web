...
describe('AdminApiService', () => {
  ...
  it('listPermissionGrants() GETs /admin/permission-grants with query params', () => {
    ...
    const req = httpMock.expectOne((r) => r.url === '/v1/admin/permission-grants');
  ...
  it('issuePermissionGrant() POSTs with an Idempotency-Key header', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/permission-grants');
  ...
  it('revokePermissionGrant() POSTs to /revoke with If-Match set to the current version', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/permission-grants/grant-1/revoke');
  ...
  it('updateProduct() PUTs with If-Match set to the given precondition', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/products/SKU-1');
  ...
  it('deactivateProduct() POSTs to /deactivate', () => {
    ...
    httpMock.expectOne('/v1/admin/products/SKU-1/deactivate').flush({});
  });

  it('createCategory() POSTs to /admin/categories', () => {
    service.createCategory({ name: 'Electronics' }, 'idem-1').subscribe();
    httpMock.expectOne('/v1/admin/categories').flush({});
  });
  ...
  it('updateCategory() PUTs with the RFC 7232 wildcard If-Match when given "*"', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/categories/cat-1');
  ...
  it('reorderCategory() POSTs the target displayOrder', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/categories/cat-1/reorder');
  ...
  it('moveCategory() POSTs the newParentId (nullable)', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/categories/cat-1/move');
  ...
  it('lockUser() POSTs an optional reason', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/users/user-1/lock');
  ...
  it('unlockUser() POSTs to /unlock', () => {
    ...
    httpMock.expectOne('/v1/admin/users/user-1/unlock').flush({});
  });
  ...
  it('replenishInventory() POSTs warehouseId/qtyAdded/reason', () => {
    ...
    const req = httpMock.expectOne('/v1/admin/inventory/SKU-1/replenish');
  ...
  it('listAdminActions() GETs /admin/actions with filters', () => {
    ...
    const req = httpMock.expectOne((r) => r.url === '/v1/admin/actions');
  ...
  it('listPrivacyRequests() GETs /admin/privacy-requests', () => {
    ...
    const req = httpMock.expectOne((r) => r.url === '/v1/admin/privacy-requests');
